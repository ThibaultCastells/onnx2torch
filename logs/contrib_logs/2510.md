...
### 2025-10-17 01:29 UTC
- Summary: Reworked static Squeeze handling to reshape away requested axes under FakeTensor/export, restoring Alibaba-NLP modernbert conversion and added Split→Squeeze→Transpose regression coverage.
- Files: onnx2torch/onnx2torch/node_converters/squeeze.py, onnx2torch/unit_tests/node_converters/squeeze_test.py, onnx2torch/logs/contrib_logs/2510.md

### 2025-10-17 01:43 UTC
- Summary: Treated CumSum axis initializers as module constants, fixed reverse-default handling, and unblocked Style-Embedding torch.export conversion.
- Files: onnx2torch/onnx2torch/node_converters/cumsum.py, logs/run_logs/20251017_014231_AnnaWegmann__Style-Embedding/run.log, logs/contrib_logs/2510.md
